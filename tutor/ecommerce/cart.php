				...
				<div class="tutor-col-lg-4">
					...
					<div class="tutor-cart-summery">
						...
						<div class="tutor-cart-summery-bottom">
							...
							<!-- Modified checkout button to redirect to homepage -->
							<a class="tutor-btn tutor-btn-primary tutor-btn-lg tutor-w-100 tutor-justify-center" href="<?php echo esc_url( home_url( '/' ) ); ?>">
