 ...
 * @since 1.0.0
 * 
 * CUSTOMIZED VERSION - Added course duration display under "About Course" heading
 * This file overrides the plugin template from: plugins/tutor/templates/single/course/course-content.php
 */
...
if ( tutor_utils()->get_option( 'enable_course_about', true, true ) ) {
	...
	<div class="tutor-course-details-content<?php echo $has_show_more ? ' tutor-toggle-more-content tutor-toggle-more-collapsed' : ''; ?>"<?php echo $has_show_more ? ' data-tutor-toggle-more-content data-toggle-height="200" style="height: 200px;"' : ''; ?>>
		...
		<?php if ( tutor_utils()->get_option( 'enable_course_duration', true, true ) ) : ?>
			<?php $course_duration = get_tutor_course_duration_context(); ?>
			<?php if ( $course_duration ) : ?>
				<div class="tutor-meta tutor-mb-16">
					<div>
						<span class="tutor-icon-clock-line tutor-meta-icon" area-hidden="true"></span>
						<span class="tutor-meta-value">
							<?php echo wp_kses( $course_duration, array( 'span' => array( 'class' => true ) ) ); ?>
						</span>
					</div>
				</div>
			<?php endif; ?>
