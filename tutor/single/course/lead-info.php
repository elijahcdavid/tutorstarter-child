 ...
 * This file overrides the plugin template from: plugins/tutor/templates/single/course/lead-info.php
 */
					...
					<div>
						...
						<?php if ( ! empty( $course_categories ) && is_array( $course_categories ) && count( $course_categories ) ) : ?>
							...
							foreach ( $course_categories as $course_category ) :
								...
								$category_links[] = wp_sprintf( '%1$s', esc_html( $category_name ) );
								endforeach;
								echo wp_kses(
